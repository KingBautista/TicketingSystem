...
export default function Navigations() {
  ...
  const handleTabSwitch = (ev, tab) => {
    ...
    const url = tab === 'trash' ? '/system-settings/archived/navigation' : '/system-settings/navigation';
  ...
  const handleBulkActionConfirmation = () => {
    ...
    switch (action) {
      case 'restore':
        url = '/system-settings/navigation/bulk/restore';
        break;
      case 'delete':
        url = activeTab === 'trash' 
          ? '/system-settings/navigation/bulk/force-delete' 
          : '/system-settings/navigation/bulk/delete';
        break;
      default:
        break;
    }
        ...
        <div className="card-header d-flex justify-content-between align-items-center">
          ...
          {access?.can_create && 
            <div className="d-flex gap-2">
              <Link to="/system-settings/navigation/create" className="btn btn-primary btn-sm" type="button">
