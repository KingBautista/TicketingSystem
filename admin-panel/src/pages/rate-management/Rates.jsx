...
export default function Rates() {
  ...
  const handleTabChange = (ev, type) => {
    ...
    setOptions(prevOptions => ({
      ...prevOptions,
      dataSource: isTrash ? '/rate-management/archived/rates' : '/rate-management/rates',
    }));
  };
  ...
  const onConfirm = () => {
    ...
    let url = '';
    if (action === 'restore') {
      url = '/rate-management/rates/bulk/restore';
    } else if (action === 'delete') {
      url = dataStatus.classTrash ? '/rate-management/rates/bulk/force-delete' : '/rate-management/rates/bulk/delete';
    }
